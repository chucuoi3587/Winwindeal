...
public class OrderDetailWS extends DataLoader {

    private Integer mOrderId;
    private DataLoaderInterface mHandler;

    public OrderDetailWS(Context context) {
        super(context);
    }
    public OrderDetailWS(Context context, DataLoaderInterface handler) {
        super(context);
    ...
    protected void startExecuteAfterAuthenticate() {
        try {
            ...
            StringBuilder query = new StringBuilder(api + Constant.API_ORDER_DETAIL);

            Log.d("TAG", "TEST WSSearchOrderDetail " + query.toString());

            URL url = new URL(query.toString());
            execute(Constant.POST_REQUEST, Constant.REQUEST_API_ORDER_DETAIL,
